...
import { BsGenderMale, BsGenderFemale, BsGenderAmbiguous, BsFire } from 'react-icons/bs'
...
const DailycaloryPage = () => {
  ...
  return (
    <>
      ...
      <div className='w-full md:w-[80%]  flex items-center justify-center h-[90vh]'>
        <div className='flex w-full flex-col'>
          <div className="flex">
            <h1 className='text-gray-300 font-semibold mb-1'>Age:</h1>
            <div
              className={`${ageErr ? 'border-red-500 ' : 'border-transparent '} border border-1 search-bar mb-2 md:md-0 flex items-center relative rounded-sm sm:w-[140px] w-[full] sm:pr-1 pr-0
               bg-zinc-800`}>
              <input
                min="1" max="120"
                value={age ? age : ''}
            ...
            <div className={`${genderErr ? 'border-red-500 ' : 'border-transparent'} border border-1 bg-zinc-800 mb-2 md:md-0 muscle_search flex items-center relative rounded-sm sm:w-[140px] w-full cursor-pointer 
                    py-1`}>
            ...
            <div className={`${heightErr ? 'border-red-500 ' : 'border-transparent'} border border-1 search-bar mb-2 md:md-0 flex items-center relative rounded-sm sm:w-[140px] w-[full] sm:pr-1 pr-0
               bg-zinc-800`}>
              <input
                value={height ? height : ''}
                onChange={(e) => {
            ...
            <div className={`${weightErr ? 'border-red-500 ' : 'border-transparent'} border border-1 search-bar mb-2 md:md-0 flex items-center relative rounded-sm sm:w-[140px] w-[full] sm:pr-1 pr-0
               bg-zinc-800`}>
              <input
                value={weight ? weight : ''}
                onChange={(e) => {
            ...
            <h1 className='text-gray-300 font-semibold mb-1'>Daily Exhaustion: </h1>
            <div className={`${levelErr ? 'border-red-500 ' : 'border-transparent'} border border-1 bg-zinc-800 mb-2 md:md-0 muscle_search flex items-center relative rounded-sm sm:w-[140px] w-full cursor-pointer 
                    py-1`}>
              <div className="selector pl-6 w-[100%] ">
            ...
            <button
              onClick={() => submitForm()}
              className='mt-3 bg-blue-400 w-[140px] text-gray-100 font-semibold py-2 flex items-center justify-center'>
            ...
            }
            {
              data ?
                ...
                <div className="flex flex-col justify-between w-full h-full p-3">
                  <div className="mb-2">
                    <h1 className="text-blue-400 font-semibold text-2xl mb-1">Daily calory</h1>
                    <h1 className="text-gray-400 text-md text-justify">Welcome to the Daily Calorie tool and here you can calculate the calories you need to maintain, lose or gain weight depending on your daily activity level.</h1>
                  </div>
                  <div>

                    <div className="mb-2">
                      <h1 className="text-blue-400 font-normal text-lg mb-1">Age</h1>
                      <h1 className="text-gray-400 text-sm">Values between: <span className="text-blue-400 text-sm">0 years - 80 years</span></h1>
                    </div>
                    <div className="mb-2">
                      <h1 className="text-blue-400 font-normal text-lg mb-1">Height</h1>
                      <h1 className="text-gray-400 text-sm">Values between: <span className="text-blue-400 text-sm">130cm  - 230cm</span></h1>
                    </div>
                    <div className="mb-4">
                      <h1 className="text-blue-400 font-normal text-lg mb-1">Weight</h1>
...
const graficCals = (name: string, cals: number, topCal: number, bottomCal: number) => {
  ...
  return (
    <div className="mt-2">
      <h1 className="text-white mb-1">{name}: <span className="text-blue-400 font-semibold">{Math.floor(cals)}</span><span className="font-ligth text-blue-400"> cals</span></h1>
